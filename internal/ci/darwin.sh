...
then
  ...
  then
    /Volumes/$QT/$QT.app/Contents/MacOS/$QT -v --script $GOPATH/src/github.com/dev-drprasad/qt/internal/ci/iscript.qs IOS=true
  else
    /Volumes/$QT/$QT.app/Contents/MacOS/$QT -v --script $GOPATH/src/github.com/dev-drprasad/qt/internal/ci/iscript.qs DARWIN=true
  fi
